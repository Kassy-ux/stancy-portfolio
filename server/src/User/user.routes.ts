...
import { register, login, uploadHeroImage, getHeroImageUrl, setResumeUrl, getResumeUrl, setTagline, getTagline, getAllSettings, updateSettings, uploadResumePdf } from './user.controller';
